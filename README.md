...
Desenvolvido por **João Vitor Mancio Chaves** (liderança técnica, gestão de projeto e
desenvolvimento), com **Matheus Cahú Monteiro dos Santos** e **Gabriel de Lima e Leão** como
